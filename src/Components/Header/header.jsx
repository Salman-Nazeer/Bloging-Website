...
//   return (
//     <Disclosure as="nav" className="bg-gray-800" state={open}>
//       <Container>
...
//       <DisclosurePanel className="sm:hidden" onClose={() => setOpen(false)}>
...
//                 onClick={() => {
//                   navigate(item.slug);
//                   setOpen(false); // Close the panel when a button is clicked
//                 }}
//                 className="hover:bg-gray-900 text-white block rounded-md px-3 py-2 text-base font-medium"
//                 // className="px-6  py-2 duration-200 hover:bg-gray-700 text-white hover:text-black rounded-full"
//               >
//                 {item.name}
//               </button>
//             ) : null
